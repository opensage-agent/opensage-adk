...
**Sandbox initializer discovery paths:**
- Built-in: `src/opensage/sandbox/initializers/`
- User-defined: `~/.local/opensage/initializers/`

**Benchmark/evaluation discovery paths:**
- Built-in: `benchmarks/{name}/`
- User-defined: `~/.local/opensage/benchmarks/{name}/`
