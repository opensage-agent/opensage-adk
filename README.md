...
> 📖 **Full Documentation**: See [docs/wiki/index.md](docs/wiki/index.md)
...
- **Sandboxed execution** support sandboxing executions of tools and targets through Docker containers
...
│   ├── patchagent/        # PatchAgent code patching
│   ├── secodeplt/         # SeCodePLT vulnerability detection
│   └── swe_bench_pro/     # SWE-bench Pro
├── docs/                  # Documentation and wiki
├── examples/              # Example configurations and agents
├── tests/                 # Unit and integration tests
└── third_party/           # External dependencies (git subtrees)
```
