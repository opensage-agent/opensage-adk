...
class SecAgent(LlmAgent):
    ...
    def __init__(self, *args, tools: Optional[List] = None, tool_combos: Optional[List[ToolCombo]] = None, reward_loggers: Optional[List[RewardLogger]] = None, **kwargs):
