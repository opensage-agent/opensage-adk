...
> [!IMPORTANT]
> You should ensure that an API key for the model you want to use is set in your environment variables or passed directly when initializing the model. For more details, see the [Docs](https://docs.adk.opensage-agent.ai/user_guide/Setup/#creating-your-own-agent).
